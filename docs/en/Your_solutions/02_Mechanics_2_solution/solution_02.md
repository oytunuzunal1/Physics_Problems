...
The total mechanical energy $E{total}$ is conserved and given by:

$$
E{total} = \frac{1}{2} k A^2
$$
...
Finding Total Mechanical Energy
$$
E{total} = \frac{1}{2} (1000\pi^2) \cdot (0.2)^2
$$

$$
E{total} = 500\pi^2 \cdot 0.04 = 20\pi^2
$$

Calculation:

$$
E{total} \approx 20 \cdot 9.8696 \approx 197.39 \text{ J}
$$

Final Result
Spring Constant: $k = 1000\pi^2 \approx 9869.6 \text{ N/m}$
Total Energy: $E
{total} = 20\pi^2 \approx 197.39 \text{ J}$
