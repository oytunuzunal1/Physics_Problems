...
$$
W = \int_{x_1}^{x2} F(x) dx
$$

Potential energy $U(x)$ is defined such that $W{conservative} = -\Delta U$.
...
Work Calculation
$$
W = \int_{0}^{x0} (-kx) dx = \left[ -\frac{1}{2}kx^2 \right]{0}^{x_0}
$$
...
Potential Energy and Verification
